	...
	<div class="h-[32rem] sm:h-full p-5 space-y-8">
		...
		<div class="p-5 px-5 bg-yellow-200 float-none rounded-xl">
			<div class="flex items-center justify-between">
				<p>My Mood</p>
				<a class='text-blue-500 underline' href="">Edit</a>
			</div>

			<div class="bg-white px-5 p-5 m-5 rounded-3xl flex items-center justify-between" v-for="mood in moods" :key="moods.mood">
				<div class="flex">
					<img class="w-5 h-5" v-bind:src="mood.imgSrc" alt="">
