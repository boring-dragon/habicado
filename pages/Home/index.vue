	...
	<div class="h-[32rem] sm:h-full p-5 space-y-8">
		...
		<div class="p-5 px-5 bg-yellow-200 float-none rounded-xl">
			<div>
				...
				<div class="space-y-4 mt-4">
					...
					<button
						class="flex items-center justify-center px-8 py-4 font-bold transition bg-secondary border-4 border-black rounded-xl focus:outline-none focus:ring shadow-[6px_6px_0_0_#000] hover:shadow-none active:bg-pink-50"
						v-if="moodChecked">
			...
			<div class="space-y-4 mt-4" v-if="!moodChecked">
				<button :key="mood.mood" @click.prevent="addMood(mood.mood)"
					class="flex items-center w-full justify-center px-8 py-4 font-bold transition bg-secondary border-4 border-black rounded-xl focus:outline-none focus:ring shadow-[6px_6px_0_0_#000] hover:shadow-none active:bg-pink-50"
					v-for="mood in moods">
					<div class="flex items-center justify-center">
		...
		<div class="p-5 px-4">
			...
			<ul class="space-y-6 mt-3">
				<li v-for="habbit in sortHabbitsByStatus">
					<div class="bg-slate-700 px-5 p-5 rounded-xl">
						<p class="text-white">{{ habbit.name }}</p>
						<div class="flex">
							<svg width="34" height="34" viewBox="0 0 13 13" fill="none"
								xmlns="http://www.w3.org/2000/svg">
								<path
									d="M3.11462 2.57291H9.88546H3.11462ZM3.65629 2.57291H9.34379V3.24999C9.34379 4.82055 8.0706 6.09374 6.50004 6.09374C4.92948 6.09374 3.65629 4.82055 3.65629 3.24999V2.57291Z"
									stroke="#D9DEDD" stroke-linecap="round" stroke-linejoin="round" />
								<path d="M4.875 5.41666H8.125" stroke="#D9DEDD" stroke-linecap="round"
									stroke-linejoin="round" />
								<path
									d="M3.11462 10.4271H9.88546H3.11462ZM3.65629 10.4271H9.34379V9.47916C9.34379 7.90859 8.0706 6.63541 6.50004 6.63541C4.92948 6.63541 3.65629 7.90859 3.65629 9.47916V10.4271Z"
									stroke="#D9DEDD" stroke-linecap="round" stroke-linejoin="round" />
							</svg>
							<div class="text-lime-200 ml-1">{{ habbit.description }}</div>
						</div>
					</div>
				</li>
			</ul>
